...
<html data-bs-theme="%THEME%">
	...
	<body>
		<div class="content" style="margin-top:12px;">
			<h2 class="center">SQUiXL | Web Portal | Widgets</h2>

			<img src="https://d2j6dbq0eux0bg.cloudfront.net/images/wysiwyg/product/90477757/743870537/17454876405541911181609/SQUiXL_Logo_Blue_Website_Transparent_png.png">
