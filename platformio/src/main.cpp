...
void create_ui_elements()
{
	...
	*/
	...
	slider_backlight_timer_battery.create_on_grid(1, 0, 2, 1);
	...
	toggle_sleep_battery.create_on_grid(0, 0, 1, 1, "SLEEP ON BAT");
	...
	slider_backlight_timer_vbus.create_on_grid(1, 0, 2, 1);
	...
	toggle_ow_enable.create_on_grid(0, 1, 1, 1, "ENABLE");
